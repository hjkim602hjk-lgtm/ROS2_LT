...
const int CURVE_IN  = -94;   // 안쪽 바퀴 (-85 x1.1)
const int CURVE_OUT = 121;   // 바깥 바퀴 (110 x1.1)
...
// 정지 -> 출발 순간 부스트
const int START_BOOST_PWM = 198;   // 180 x1.1
const unsigned long START_BOOST_MS = 120;

// 직각 회전 기본 PWM
const int PIVOT = 149;             // 135 x1.1
