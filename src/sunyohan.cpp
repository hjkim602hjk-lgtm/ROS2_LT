...
const int CURVE_IN  = -85;  // 안쪽 바퀴 (-85 x1.1)
const int CURVE_OUT = 130;  // 바깥 바퀴 (110 x1.1)
...
const unsigned long CORNER_MS = 190;   // 실주행 튜닝값 (기준선 250)
...
const int CURVE_BACK_PWM = 94;           // 85 x1.1
...
const unsigned long EXIT_BOOST_MS = 120;
